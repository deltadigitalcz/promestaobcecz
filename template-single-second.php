<?php
/*
  Template Name: Titulní obrázek celý
	...
	<div class="container position-relative" data-sticky-container>
        <div class="row mt-3">
            <div class="col-12">
                ...
                <li class="nav-item">
                    <div class="nav-link">
                        <a href="<?php echo get_author_posts_url( $post->post_author ) ?>" class=" text-reset btn-link"><?php echo get_the_author_meta( 'display_name', $post->post_author )?></a>
                    </div>
                </li>
		...
		<div class="row">
			...
			<div class="col-lg-9 mb-5">
                <img class="rounded mt-5 mb-2" src="<?php the_post_thumbnail_url('large') ?>" alt="Image"> 
      	        <?php the_content() ?>
			</div>
			<!-- Main Content END -->
